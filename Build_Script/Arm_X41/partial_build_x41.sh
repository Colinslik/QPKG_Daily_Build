...
export PATH=/opt/cross-project/arm/linaro/bin/:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:${PATH}
export CROSS_COMPILE=arm-linux-gnueabihf-
export ARCH=arm
export SYS_TARGET_PREFIX=/opt/cross-project/arm/linaro/arm-linux-gnueabihf/libc
export TARGET_PREFIX=/opt/cross-project/arm/linaro/arm-linux-gnueabihf/libc
export TARGET_PLATFORM=ARM_AL
