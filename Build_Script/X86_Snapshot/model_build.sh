...
Version_src=/mnt/vdisk/git_version/

git_model_path=Model/TS-470/
...
# Versioning pull
cd $Version_src
echo "===========Start Pull Versioning ... ===========" >> $log_path$log_name 2>&1
echo " " >> $log_path$log_name 2>&1

git pull >> $log_path$log_name 2>&1

echo " " >> $log_path$log_name 2>&1
echo "===========END Pull Versioning ... =============" >> $log_path$log_name 2>&1
echo " " >> $log_path$log_name 2>&1
