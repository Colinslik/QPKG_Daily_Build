...
function Build_RTRR_LIB(){
	...
	make RECYCLE_EX=yes STORAGE_V2=yes >> $log_path$log_name 2>&1
	...
	make clean 1>/dev/null 2>/dev/null
	make RECYCLE_EX=yes STORAGE_V2=yes ENABLE_LIMITRATE=yes >> $log_path$log_name 2>&1
...
function Build_RTRR_BIN(){
	...
	make clean 1>/dev/null 2>/dev/null	
	make RECYCLE_EX=yes STORAGE_V2=yes ENABLE_LIMITRATE=yes LDAP=yes >> $log_path$log_name 2>&1
