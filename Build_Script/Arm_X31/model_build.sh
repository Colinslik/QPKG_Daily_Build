...
export CVSROOT=":ext:$USER@172.17.21.8:/home/cvsroot"
...
cp /mnt/vdisk/touchall.sh /mnt/vdisk/git_4.2.0/touchall.sh

/mnt/vdisk/git_4.2.0/touchall.sh >> $log_path$log_name 2>&1
...
make STORAGE_V2_UI4=yes OPENSSL_VER=1.0  >> $log_path$log_name 2>&1
