...
function Build_RTRR_LIB(){
	...
	make RECYCLE_EX=yes >> $log_path$log_name 2>&1
	...
	make clean 1>/dev/null 2>/dev/null
	make RECYCLE_EX=yes ENABLE_LIMITRATE=yes >> $log_path$log_name 2>&1
...
function Build_RTRR_BIN(){
	...
	make clean 1>/dev/null 2>/dev/null	
	make RECYCLE_EX=yes ENABLE_LIMITRATE=yes LDAP=yes >> $log_path$log_name 2>&1
...
function Build_Rsync_LIB(){
	...
	echo " " >> $log_path$log_name 2>&1
        arm-none-linux-gnueabi-gcc -I$git_src_model../../Kernel/linux-3.4.6/include -I../uLinux -I../include -I../common -I../libnaslog-2.0.0 -I../../DataService/DBMS/sqlite/sqlite-3.4.1 -I../../DataService/DBMS/sqlite/sqlite-3.4.1/src -I$git_src_model../../Kernel/linux-3.4.6/include/qnap -I/opt/cross-project/arm/marvell/arm-none-linux-gnueabi/libc/marvell-f/usr/include -I../../Include -I../ini_config -U_FORTIFY_SOURCE -fPIC -Wall -c -O -DSYNC_BY_NFS -DMARVELL_6281  -DTS419 -DENCRYPTFS -DNAS_VIRTUAL -DNAS_VIRTUAL_EX -DAPACHE_WEBDAV -DAPACHE_SSL -DUIV2 -DTS419 -DM_DEFAULT_SHARE -DIPV6 -DTIMEMACHINE -DPARAGON_NTFS -DNFSV4 -DHFSPLUS -DLIO_TARGET -DACL -DDISK_REORDER -DLDAP -DMS_DFS -DEXT_ENCRYPTION -DSUPPORT_SINGLE_INIT_LOGIN -DMUSICSTATION -DPHOTOSTATION2 -DPUBLIC_PHOTOSTATION -DRECYCLE_EX -DQOS4 -D_QNAP_ARM_ -DQBOX_SUPPORT -DLIBRSYNC -DUSER_GROUP_DB -DPRODUCTION -DSYSLOG_SERVER -DRADIUS -DQNAPDDNS -DWIRELESS -DCUPS -DCLAMAV -I../../NasLib/replication/library -DSUPPORT_LIMITRATE -DVPN_OPENVPN -DVPN_PPTP -DLDAP_SERVER -DPUSH_NOTIFICATION -DNSS_V2 -I../../Include -DNSS_V2 -I../qlicense2 cfg_rsync.c -o cfg_rsync.o >> $log_path$log_name 2>&1
	...
	echo " " >> $log_path$log_name 2>&1	
        arm-none-linux-gnueabi-gcc -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE  -DTS419 -DENCRYPTFS -DNAS_VIRTUAL -DNAS_VIRTUAL_EX -DAPACHE_WEBDAV -DAPACHE_SSL -DUIV2 -DTS419 -DM_DEFAULT_SHARE -DIPV6 -DTIMEMACHINE -DPARAGON_NTFS -DNFSV4 -DHFSPLUS -DLIO_TARGET -DACL -DDISK_REORDER -DLDAP -DMS_DFS -DEXT_ENCRYPTION -DSUPPORT_SINGLE_INIT_LOGIN -DMUSICSTATION -DPHOTOSTATION2 -DPUBLIC_PHOTOSTATION -DRECYCLE_EX -DQOS4 -D_QNAP_ARM_ -DQBOX_SUPPORT -DLIBRSYNC -DUSER_GROUP_DB -DPRODUCTION -DSYSLOG_SERVER -DRADIUS -DQNAPDDNS -DWIRELESS -DCUPS -DCLAMAV -I../../NasLib/replication/library -DSUPPORT_LIMITRATE -DVPN_OPENVPN -DVPN_PPTP -DLDAP_SERVER -DPUSH_NOTIFICATION -shared -Wl,-soname,libuLinux_config.so.0 -o libuLinux_config.so.0.0 ../common/nas_lib_common.o cfg_system.o cfg_alert.o cfg_network.o cfg_samba.o cfg_appletalk.o cfg_nfs.o cfg_webfs.o cfg_smtp.o gw.o ifcfg.o sem.o cfg_display.o cfg_misc.o msg.o hardware.o cfg_ftp.o cfg_snmp.o cfg_nic.o cfg_printer.o cfg_logo.o mangle.o cfg_system_recover.o cfg_save_restore.o cfg_ntp.o cfg_rtrr.o cfg_rsync.o cfg_qphoto.o cfg_qmultimedia.o cfg_qdownload.o cfg_qweb.o cfg_qwebdav.o base64.o eventlog_mgr.o cfg_backup.o cfg_ddns.o cfg_dhcp.o cfg_tftp.o cfg_fw.o cfg_recycle_bin.o cfg_mysql.o cfg_ip_filter.o cfg_ups.o cfg_login.o cfg_usb_button.o cfg_hdcopyusb.o pl_parser.o  cfg_buzzer.o cfg_sms.o cfg_qsurveillance.o cfg_bonjour.o cfg_redundant_power.o cfg_upnp.o cfg_ldap.o cfg_applog.o cfg_medialibrary.o cfg_versioning.o cfg_qbox.o cfg_qpkg.o cfg_iscsi.o cfg_iscsi_lio.o ../ini_config/err_trace.o ../ini_config/ini_config.o ../ini_config/minIni.o cfg_amazons3.o cfg_qfan.o cfg_timemachine.o cfg_syslog.o cfg_radius.o cfg_upnpc.o cfg_qnapddns.o cfg_antivirus.o custom_lib.o cfg_vpn.o cfg_ldap_server.o -lc -lcrypt -L/mnt/vdisk/git_4.2.0/NasLib/config/../.build/usr/lib -L/opt/cross-project/arm/marvell/arm-none-linux-gnueabi/libc/marvell-f/lib -L/opt/cross-project/arm/marvell/arm-none-linux-gnueabi/libc/marvell-f/usr/lib -L../ini_config -luLinux_Util -luLinux_NAS -luLinux_Storage -luLinux_quota -luLinux_PDC -luLinux_cgi -lpthread -luLinux_ini -lm -lssl -lcrypt -lcrypto  >> $log_path$log_name 2>&1
	...
	echo " " >> $log_path$log_name 2>&1	
        arm-none-linux-gnueabi-gcc -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE  -DTS419 -DENCRYPTFS -DNAS_VIRTUAL -DNAS_VIRTUAL_EX -DAPACHE_WEBDAV -DAPACHE_SSL -DUIV2 -DTS419 -DM_DEFAULT_SHARE -DIPV6 -DTIMEMACHINE -DPARAGON_NTFS -DNFSV4 -DHFSPLUS -DLIO_TARGET -DACL -DDISK_REORDER -DLDAP -DMS_DFS -DEXT_ENCRYPTION -DSUPPORT_SINGLE_INIT_LOGIN -DMUSICSTATION -DPHOTOSTATION2 -DPUBLIC_PHOTOSTATION -DRECYCLE_EX -DQOS4 -D_QNAP_ARM_ -DQBOX_SUPPORT -DLIBRSYNC -DUSER_GROUP_DB -DPRODUCTION -DSYSLOG_SERVER -DRADIUS -DQNAPDDNS -DWIRELESS -DCUPS -DCLAMAV -I../../NasLib/replication/library -DSUPPORT_LIMITRATE -DVPN_OPENVPN -DVPN_PPTP -DLDAP_SERVER -DPUSH_NOTIFICATION -shared -Wl,-soname,libuLinux_config_ext.so.0 -o libuLinux_config_ext.so.0.0 cfg_remote_folder.o -lc -lcrypt -L../../SysLib/json-c-0.9/.libs -ljson -L/mnt/vdisk/git_4.2.0/NasLib/config/../.build/usr/lib -L/opt/cross-project/arm/marvell/arm-none-linux-gnueabi/libc/marvell-f/lib -L/opt/cross-project/arm/marvell/arm-none-linux-gnueabi/libc/marvell-f/usr/lib -L../ini_config -luLinux_Util -luLinux_NAS -luLinux_Storage -luLinux_quota -luLinux_PDC -luLinux_cgi -lpthread -luLinux_ini -lm -lssl -lcrypt -lcrypto >> $log_path$log_name 2>&1
